...
//            var existingImage = await _userImageRepository.GetByIdAsync(imageId.Value);
...
//            var image = await _userImageRepository.GetByIdAsync(imageId.Value);
//            if (image == null)
//                return false;
...
//            {
//                UserImageID = img.UserImageID,
//                FileName = img.FileName,
//                FilePath = $"/userImages/{img.FileName}"
//            });
//        }
